...
from app.templatetags.custom_filters import get_rate, get_calculated_rate, get_project_set_total
...
class CustomFiltersTest(TestCase):
    def setUp(self):
        ...
        self.project1 = Project.objects.create(name="Project 1", start_date="2024-10-01", end_date="2024-10-03", city=self.city_low)
        self.project2 = Project.objects.create(name="Project 2", start_date="2024-10-01", end_date="2024-10-03", city=self.city_high)
    ...
    def test_get_total_cost(self):
        ...
        self.assertEqual(get_project_set_total(self.project1, self.project1.set), "$300.00")
